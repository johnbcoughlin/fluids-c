...
pub fn initialize_storage<GS, Fx>(u_0: Fx, n_p: i32, grid: &grid::Grid<GS>, operators: &Operators)
...
pub fn communicate<GS: GalerkinScheme>(t: f64, grid: &grid::Grid<GS>, storages: &Vec<ElementStorage<GS::U, GS::F>>) {
    for (i, elt) in grid.elements.iter().enumerate() {
